...
class RatesServiceTest {
    ...
    private lateinit var service: com.currency.converter.app.api.RatesService
    ...
    fun fetchRates() {
        ...
        assertThat<com.currency.converter.app.api.RatesResult>(rates, IsNull.notNullValue())
        assertThat(
            rates!!.success,
            `is`(true)
        )
